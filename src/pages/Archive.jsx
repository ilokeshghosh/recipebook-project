...
export default function Archive() {
  ...
  return (
    <main
      className="w-full md:pt-[5rem] pb-20 md:pb-0"
      style={{ fontFamily: "Cormorant Infant, sans-serif" }}
    >
      <img
        className="w-full md:h-[250px] h-[200px] md:inline-block hidden"
      ...
      <div className="md:px-32 px-8 py-6">
        ...
        {/* food container */}
        <div className="flex gap-2 w-full md:justify-between justify-center   md:w-auto  flex-wrap px-2 md:px-0">
          {loading ? (
            <>
              <div className="w-[300px] h-[200px] skeleton"></div>
              <div className="w-[300px] h-[200px] skeleton"></div>
              <div className="w-[300px] h-[200px] skeleton"></div>
              <div className="w-[300px] h-[200px] skeleton"></div>
              <div className="w-[300px] h-[200px] skeleton"></div>
